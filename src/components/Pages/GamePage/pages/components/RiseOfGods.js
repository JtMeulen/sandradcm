...
const RiseOfGods = (props) => {
	...
	const thumbnails = [
		{options: 'isSmall', image: '1ykTcQjisNjD7ZrRH-PjfSxzz89eIYMQ6', text: 'Example of a fully finished Warrior Card'}, //0
		{options: 'isSmall', image: '1jt8uy2f7U00oLC5T4WCEZGVKQ7TwhvXJ', text: 'Example of a fully finished Ability Card'}, //1
		{image: '1nZ2g2PpopxF4QokAtJA2bkai1UvWgMtl', text: 'Example of the back of the cards'}, //2
		{options: 'isSmall', image: '10qV8Uv0-mwE27CzLTWhClcO4uzMfR6pA', text: 'Hadrian is the Discipple of the Aggressive playing style'}, //3
		{options: 'isSmall', image: '1CooJBQkYV06fW_j0MAM07j6SMF-vb90O', text: 'Messina is the Discipple of the Adaptive playing style'}, //4
		{options: 'isSmall', image: '15vW8VZfpbEyNCG8sNu0XNHa3IQ-YVzKZ', text: 'Balint is the Discipple of the Defensive playing style'} //5
	];
