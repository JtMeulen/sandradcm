  ...
  return (
		<Fragment>
			...
			<div className={cn(styles.mainContent, { [styles.mobileContent]: isMobile })}>
				...
				<Thumbnails thumbnails={thumbnails} positions={[13,14,15]} height={248} marginBottom={33} />
				...
				<Thumbnails thumbnails={thumbnails} positions={[22,23,24]} height={298} marginBottom={33} />
				...
				<Thumbnails thumbnails={thumbnails} positions={[34,35,36]} height={248} marginBottom={0} />
				<p>
